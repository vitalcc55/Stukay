...
- `.\gradlew.bat :core:model:testDebugUnitTest :feature:projects:testDebugUnitTest :feature:thread:testDebugUnitTest` confirms DDD-lite fake domain and typed shell behavior after stage 3 on `2026-05-02`.
